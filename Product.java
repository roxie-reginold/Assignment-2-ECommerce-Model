...
{ // shoes category added for Shoes.java
	...
	{
		if (productOptions == null || productOptions == ""){ // if the product option is empty return true
			return true;
		}else{
			return false; // if the product option is not empty return false
		}
	...
	/*
	 * Increases the number of items currently in stock for this product by 1 (called when a product order
	 * has beem canceled by a customer)
	 * Note: in this general class, the productOptions parameter is not used. It may be used
	 * in subclasses. (added)
	 */
	public void increaseStockCount(String productOptions)
	{
		stockCount++;
	}
